...
public class SachAdapterRecyclerViewHorizontal extends RecyclerView.Adapter<SachAdapterRecyclerViewHorizontal.SachViewHolder>{
    ...
    @NonNull
    @Override
    public SachAdapterRecyclerViewHorizontal.SachViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View convertView = LayoutInflater.from(this.context).inflate(R.layout.item_recyclerview_horizontal, parent, false);
